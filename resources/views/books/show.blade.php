            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="flex flex-col md:flex-row gap-6">
                        <div class="md:w-1/3">
                            <div class="flex justify-center items-center rounded-md overflow-hidden shadow-sm border border-gray-200 mb-4 mx-auto"
                                style="width: 136px; height: 196px;">
                                ...
                                @else
                                    <div class="w-full h-full bg-gray-200 flex items-center justify-center text-gray-400 font-bold text-sm p-2 text-center">
                                        No Image
                                    </div>
                                @endif
                            </div>
                    ...
                    <div class="mt-8 pt-8 border-t border-gray-200">
                            ...
                            <div class="mb-6 bg-gray-50 p-4 rounded-lg">
                                ...
                                <form action="{{ route('reviews.store', $book) }}" method="POST" novalidate>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select name="rating" id="rating" class="rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea name="comment" id="comment" rows="3" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" placeholder="感想を入力してください（400文字以内）">{{ old('comment') }}</textarea>
                                        @error('comment')
                        ...
                        @else
                            <p class="text-sm text-gray-500 mb-6">レビューを投稿するには<a href="{{ route('login') }}" class="text-blue-600 hover:underline mx-1">ログイン</a>してください。</p>
                        @endauth
