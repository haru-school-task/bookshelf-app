                    ...
                    <div class="flex flex-col md:flex-row gap-6">
                        <div class="md:w-1/3">
                            @if (!empty($book->image_url))
                                <!-- 【レイアウト崩れ完全防止＆画像強制表示版】 -->
                                <div class="flex justify-center items-center rounded-md overflow-hidden shadow-sm border border-gray-200 mb-4"
                                    style="width: 136px; height: 196px;">
                                    <img src="{{ $book->image_url . '&printsec=frontcover&img=1&zoom=1' }}"
                                        alt="{{ $book->title }}" class="w-full h-full object-cover shadow-sm rounded-md"
                                        onerror="this.onerror=null; this.src='https://placeholder.com';">
                                </div>
                            @else
                                <!-- 本当にデータベースの中身が空っぽ（null）のときだけ、安全な代替テキストを出します -->
                                <div class="flex justify-center items-center bg-gray-100 text-gray-400 rounded-md border border-gray-200"
                                    style="width: 136px; height: 196px;">
                                    <span class="text-xs font-medium">画像なし</span>
                                </div>
                            @endif
                        </div>
                        <div class="md:w-2/3">
                            ...
                            <p class="text-gray-600 mb-2"><strong>出版日:</strong> {{ $book->published_date ?? '未登録' }}
                            </p>
                            <div class="mb-4">
                                <strong>ジャンル:</strong>
